...
class Grounder :
    ...
    def __init__(self, ontology, perception_module=None, kb_predicates=None, classifier_predicates=None, test_features_file=None) :
        ...
        if test_features_file is not None :
            self.test_object_features = numpy.loadtxt(test_features_file, delimiter=',')
