...
S\-P\-H\-I\-N\-X\-B\-A\-S\-E\-\_\-\-E\-X\-P\-O\-R\-T int16 $\ast$ {\bf bio\-\_\-read\-\_\-wavfile} (char const $\ast$directory, char const $\ast$filename, char const $\ast$extension, int32 header, int32 endian, size\-\_\-t $\ast$nsamps)
...
\item[{int32}]{header, }
\item[{int32}]{endian, }
\item[{size\-\_\-t $\ast$}]{nsamps}
\end{DoxyParamCaption}
)}\label{bio_8h_ad878e862c10ca00d8ed7d0e7c21fc5c9}
