...
class Parser:
    ...
    def parse_tokens(self, tokens, k=None, n=1):
        ...
        full_parse_scores = [self.learner.score_parse(tokens, fp) for fp in full_parses]
        k_best = []
    ...
    def perform_adjectival_type_raise(self, A):
        ...
        if not raised.validate_tree_structure():
    ...
    def perform_merge(self, A, B):
        ...
        if not A_B_merged.validate_tree_structure():
            sys.exit("ERROR: invalidly linked structure generated by FA: "+
    ...
    def perform_fa(self, A, B):
        ...
        if not A.is_lambda and self.ontology.preds[A.idx] == 'and':
            ...
            print "detect 'and' consumption of B" #DEBUG
            ...
            if not A_new.validate_tree_structure():
                sys.exit("ERROR: invalidly linked structure generated by FA: "+
        ...
        if not A_FA_B.validate_tree_structure():
            sys.exit("ERROR: invalidly linked structure generated by FA: "+
