...
class Knowledge:
    ...
    def __init__(self):
        ...
        self.goal_params_values = ['peter', 'ray', 'dana', 'kazunori', 'matteo', 'shiqi', 'jivko', 'stacy' 'yuqian', 'max', 'pato', 'bwi', 'bwi-meeting', '3516', '3508', '3512', '3510', '3402', '3418', '3420', '3432', '3502', '3414b']
